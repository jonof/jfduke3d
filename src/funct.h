...
extern void overwritesprite(int thex,int they,short tilenum,signed char shade,char stat,char dapalnum);
extern void timerhandler(void);
extern int gametext(int x,int y,const char *t,char s,short dabits);
extern int gametextpal(int x,int y,const char *t,char s,char p);
extern int gametextpart(int x,int y,const char *t,char s,short p);
extern int minitext(int x,int y,const char *t,char p,short sb);
extern int minitextshade(int x,int y,const char *t,char s,char p,short sb);
...
extern void invennum(int x,int y,char num1,char ha,char sbits);
...
extern void digitalnumber(int x,int y,int n,char s,char cs);
extern void scratchmarks(int x,int y,int n,char s,char p);
