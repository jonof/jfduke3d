...
extern int gametext(int x,int y,const char *t,signed char s,short dabits);
extern int gametextpal(int x,int y,const char *t,signed char s,unsigned char p);
extern int gametextpart(int x,int y,const char *t,signed char s,short p);
extern int minitext(int x,int y,const char *t,unsigned char p,short sb);
extern int minitextshade(int x,int y,const char *t,signed char s,unsigned char p,short sb);
extern void gamenumber(int x,int y,int n,signed char s);
